...
def test_cleanup_removes_old_cache_files(tmp_path: Path) -> None:
...
def test_cleanup_preserves_current_cache(tmp_path: Path) -> None:
...
def test_cleanup_no_cache_files(tmp_path: Path) -> None:
